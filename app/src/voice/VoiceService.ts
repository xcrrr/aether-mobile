 ...
 *
 * Uses the device's built-in recognition engine, so availability and offline
 * behavior depend on the installed Android speech service. One recognizer at a time: starting a
