...
import { fonts, spacing, Palette, fontSize } from '@/theme';
...
const makeStyles = (c: Palette) => StyleSheet.create({
  ...
  title: { color: c.text, fontSize: fontSize.base, fontFamily: fonts.sansSemibold },
  msg: { color: c.textMuted, fontSize: fontSize.sm, fontFamily: fonts.mono, textAlign: 'center' },
});
