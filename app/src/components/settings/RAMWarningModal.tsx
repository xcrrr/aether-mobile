...
const makeStyles = (c: Palette) => StyleSheet.create({
  ...
  card: { width: '100%', maxWidth: 340, backgroundColor: c.bgCard, borderColor: c.border, borderWidth: 1, borderRadius: radius.md, padding: spacing.xl, gap: spacing.md },
  ...
  statLabel: { color: c.textMuted, fontSize: fontSize.sm2, fontFamily: fonts.sans },
  statValue: { color: c.text, ...typography.button },
